...
//        $uikNumbersWithKoib = $this->getUikNumbersWithKoib();
        ...
        $outputFile = PROJECT_ROOT_DIR . "/output/uiks-{$this->resources->getGeoRegion()->getCurrentRegionId()}-{$this->resources->getGeoRegion()->getCurrentRegion()}.csv";
        $csv->open($outputFile, CsvWriter::WITH_HEADERS, ['ТИК', 'УИК', 'Адрес', 'Телефон']);
